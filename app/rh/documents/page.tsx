...
export default function RHDocumentsPage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // Charger tous les documents pour RH
  ...
  const filteredDocuments = documents.filter((document) => {
    const matchesSearch =
      ...
      (document.users?.name && document.users.name.toLowerCase().includes(searchTerm.toLowerCase()))
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-gray-600">Consulter et gérer tous les documents du système</p>
            </div>
            <Button>
